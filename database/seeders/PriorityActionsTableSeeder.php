...
class PriorityActionsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        \DB::table('priority_actions')->insert([
            [
                'id' => '1.1',
                'short_name' => 'Promote integration of AE approaches in policies and plans',
            ...
            [
                'id' => '1.2',
                'short_name' => 'Strengthen public policies (markets)',
            ...
            [
                'id' => '1.3',
                'short_name' => 'Enhance cross-sectoral policy coherence',
            ...
            [
                'id' => '1.4',
                'short_name' => 'Strengthen policies to address gender inequality',
            ...
            [
                'id' => '2.1',
                'short_name' => 'Encourage data collection and analysis at national level',
            ...
            [
                'id' => '2.2',
                'short_name' => 'Holistic assessments',
            ...
            [
                'id' => '2.3',
                'short_name' => 'Assess and document the contribution of agroecology to FSN',
            ...
            [
                'id' => '2.4',
                'short_name' => 'Sharing of AE principles and practices',
            ...
            [
                'id' => '3.1',
                'short_name' => 'Advocate for diversified production systems',
            ...
            [
                'id' => '3.2',
                'short_name' => 'Promote alternatives to chemical pesticides',
            ...
            [
                'id' => '3.3',
                'short_name' => 'Responsible investment and social innovation in MSMEs',
            ...
            [
                'id' => '3.4',
                'short_name' => 'Market and social innovations linking urban and rural',
            ...
            [
                'id' => '3.5',
                'short_name' => 'Awareness of AE contribution to SDGs and KJWA',
            ...
            [
                'id' => '3.6',
                'short_name' => 'Recognize value of and strengthen support for AE approaches',
            ...
            [
                'id' => '4.1',
                'short_name' => 'Increased resource allocation in public and private research',
            ...
            [
                'id' => '4.2',
                'short_name' => 'Transdisciplinary research and innovation platforms',
            ...
            [
                'id' => '4.3',
                'short_name' => 'Responsible investment in participatory research and innovation',
            ...
            [
                'id' => '4.4',
                'short_name' => 'Horizontal knowledge sharing',
            ...
            [
                'id' => '4.5',
                'short_name' => 'Horizontal sharing of knowledge and experiences',
                'name' => 'Support horizontal sharing of knowledge and experiences building on existing producer organizations and networks with a focus on women, youth, local and indigenous communities.',
                'recommendation_id' => 4,
            ],
            [
                'id' => '5.1',
                'short_name' => 'Property rights for small-scale producers and indigenous peoples',
            ...
            [
                'id' => '5.2',
                'short_name' => 'Participation of marginalized and vulnerable groups',
                'name' => 'Ensure participation of marginalized and vulnerable groups at all levels of decision-making in the food system',
                'recommendation_id' => 5,
            ],
            [
                'id' => '5.3',
                'short_name' => 'Empowerment of women small-scale food producers and family farmers',
            ...
            [
                'id' => '5.4',
                'short_name' => 'Linkages between urban communities and food production systems',
