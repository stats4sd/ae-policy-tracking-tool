    ...
    <div>
            ...
            @foreach($recommendations as $recommendation)
                ...
                <div class="a4-page">
                    ...
                    <div class="bg-white border-x border-x-gray-300 border-b border-b-gray-300 px-10 lg:px-24 pt-8 pb-10">

                        <div class="border-b-2 border-b-dark-title-block flex flex-col gap-4 pb-8">
